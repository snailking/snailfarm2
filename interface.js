...
function SeedMarket(eggs, acorns, eth, callback){
    ...
    var outputData = myContract.SeedMarket.getData(eggs, acorns);
...
function SellAcorns(acorns, callback){
    var contractAbi = web3.eth.contract(abi);
    var myContract = contractAbi.at(contractAddress);
    var outputData = myContract.SellAcorns.getData(acorns);
    var endstr=web3.eth.sendTransaction({to:contractAddress, from:null, data: outputData},
    function(error,result){
        if(!error){
            console.log('SellAcorns ',);
            callback()
        }
        else{
            console.log('error :(')
...
function BuyAcorns(eth, callback){
    var contractAbi = web3.eth.contract(abi);
    var myContract = contractAbi.at(contractAddress);
    var outputData = myContract.BuyAcorns.getData();
    var endstr=web3.eth.sendTransaction({to:contractAddress, from:null, data: outputData, value: eth},
    function(error,result){
        if(!error){
            console.log('BuyAcorns ',);
            callback()
        }
        else{
            console.log('error :(')
...
function HatchEggs(eth, callback){
    var contractAbi = web3.eth.contract(abi);
    var myContract = contractAbi.at(contractAddress);
    var outputData = myContract.HatchEggs.getData();
    var endstr=web3.eth.sendTransaction({to:contractAddress, from:null, data: outputData,value: eth},
    function(error,result){
        if(!error){
            console.log('HatchEggs ',eth);
            callback()
        }
        else{
            console.log('error :(')
...
function BuyStartingSnails(eth, callback){
    var contractAbi = web3.eth.contract(abi);
    var myContract = contractAbi.at(contractAddress);
    var outputData = myContract.BuyStartingSnails.getData();
    var endstr=web3.eth.sendTransaction({to:contractAddress, from:null, data: outputData, value: eth},
    function(error,result){
        if(!error){
            console.log('BuyStartingSnails ', eth);
            callback()
        }
        else{
            console.log('error :(')
...
function BecomeSquirrelDuke(callback){
    ...
    function(error,result){
        if(!error){
            console.log('BecomeSquirrelDuke ',);
            callback()
        }
        else{
            console.log('error :(')
...
function BecomeTadpolePrince(eth, callback){
    ...
    function(error,result){
        if(!error){
            console.log('BecomeTadpolePrince ', eth);
            callback()
        }
        else{
            console.log('error :(')
...
function ComputeAcornPrice(callback){
    var contractAbi = web3.eth.contract(abi);
    var myContract = contractAbi.at(contractAddress);
    var outputData = myContract.ComputeAcornPrice.getData();
...
function previousSnailPot(callback){
    var contractAbi = web3.eth.contract(abi);
    var myContract = contractAbi.at(contractAddress);
    var outputData = myContract.previousSnailPot.getData();
    var endstr=web3.eth.call({to:contractAddress, from:null, data: outputData},
    function(error,result){
        if(!error){
            console.log('previousSnailPot ',web3.toDecimal(result));
            callback(web3.toDecimal(result))
        }
        else{
            console.log('error :(')
...
function ComputeEggsSinceLastHatch(adr,callback){
    var contractAbi = web3.eth.contract(abi);
    var myContract = contractAbi.at(contractAddress);
    var outputData = myContract.ComputeEggsSinceLastHatch.getData(adr);
    var endstr=web3.eth.call({to:contractAddress, from:null, data: outputData},
    function(error,result){
        if(!error){
            console.log('ComputeEggsSinceLastHatch ',web3.toDecimal(result));
            callback(web3.toDecimal(result))
        }
        else{
            console.log('error :(')
...
function ComputeMyEggs(callback){
    var contractAbi = web3.eth.contract(abi);
    var myContract = contractAbi.at(contractAddress);
    var outputData = myContract.ComputeMyEggs.getData();
    var endstr=web3.eth.call({to:contractAddress, from:null, data: outputData},
    function(error,result){
        if(!error){
